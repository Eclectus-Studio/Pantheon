...
public class TexturedChestplateItem extends TexturedEquipmentItem {
    public TexturedChestplateItem(ResourceLocation id, ItemStack itemStack, int maxDamage, ItemStack repairIngredient, Equipment equipment, EquipmentSlot slot) {
    ...
    public TexturedChestplateItem(ResourceLocation id, ItemStack itemStack, int maxDamage, ItemStack repairIngredient, ResourceLocation equipmentResourceLocation, EquipmentSlot slot) {
