...
public class TexturedBootItem extends TexturedEquipmentItem {
    public TexturedBootItem(ResourceLocation id, ItemStack itemStack, ResourceLocation equipmentResourceLocation) {
    ...
    public ItemStack createStack() {
        ...
        Equippable equippableComponent = Equippable.equippable(EquipmentSlot.FEET)
