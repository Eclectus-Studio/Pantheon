...
public class HumanoidEquipment extends Equipment {
    public HumanoidEquipment(ResourceLocation location) {
        super(location);
        this.addSimpleLayer(EquipmentLayerType.HUMANOID, location);
    }
}
